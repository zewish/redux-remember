...
hero:
  ...
  image:
    file: ../../assets/logo-remember.webp
  actions:
    - text: Quick Start
      link: ./quick-start/
      icon: right-arrow
...
- Use [Redux Remigrate](./usage/migrations/) for migrations with auto-generated types and CLI tooling.
...
<CardGrid>
  ...
  <LinkCard title="Migrations with Redux Remigrate" href="./usage/migrations/" />
