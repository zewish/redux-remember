...
declare const rememberEnhancer: <Ext = {}, StateExt = {}>(driver: Driver, rememberedKeys: string[], { prefix, serialize, unserialize, persistThrottle, persistWholeStore }?: Partial<Options>) => StoreEnhancer<Ext, StateExt>;
